	...
	$(add_button).click(function(e){
        ...
        if(x < max_fields){ 
            x++; //input field increment
			 //add input field
            $(wrapper).append('<div class="form-floating mb-3 mt-3 col-8"> <input type="text" class="form-control" id="tagid" name="tagid[]" placeholder="tagid" required> <label for="tagid">Tag ID</label><a href="javascript:void(0);" class="remove_field">Remove</a></div>');
        }
    });
...
//Add Input Fields (add)
$(document).ready(function() {
    var max_fields1 = 100; //Maximum allowed input fields 
	...
	$(add_button1).click(function(e){
        ...
        if(x < max_fields1){ 
            x++; //input field increment
			 //add input field
            $(wrapper1).append('<div class="form-floating mb-3 mt-3 col-8"> <input type="text" class="form-control" id="tgid" name="tgid[]" placeholder="tagid" required> <label for="tgid">Tag ID</label><a href="javascript:void(0);" class="remove_field1">Remove</a></div>');
        }
    });
  ...
  <div class="container-fluid" id="1">
    ...
    <div class="row justify-content-center">
      <div class="col-md-6" id="adpd">
        ...
        <form method="POST" action="dash.php" name="addprod" onsubmit="return adprod();">
          ...
          <a class="add_fields">Add More</a>

          <div class="row mt-3">
            <div class="col-6 text-end ">
            <a class="btn" id="btn" role="button" onclick="pl();">Back</a>
...
<br>
      ...
      <form method="POST" action="dash.php" name="editprod" onsubmit="return edprod();">
          <div class="form-floating mb-3 mt-3">
          ...
          <div class="form-floating mb-3 mt-3 col-8">
          <input type="text" class="form-control" id="tgid" name="tgid[]" placeholder="tagid" required>
          <label for="tgid">Tag ID</label>
       </div>
          </div>
          <a class="add_fields1">Add More</a>

          <div class="row mt-3">
            <div class="col-6 text-end ">
            <a class="btn" id="btn" role="button" onclick="plb();">Back</a>
              <input class="btn" type="submit" id="btn" role="button" name="addtag" value="Add Tag">
            </div>
          </div>
        </form>
        <?php
          ...
          <tbody id="myTables">
            ...
            ?>
                <tr>
                  ...
                  <td><a href="dash.php?pid=<?php echo $row5['product_id'];?>">Edit</a></td>
                </tr>
                <?php
              }
            }
